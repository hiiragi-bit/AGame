#include "Base/Base.h"
#include "Game(EX1)/Player.h"
#include "Game(EX1)/FollowCamera.h"
#include "Game(EX1)/Field.h"
//--------------------------------------------
//グローバル変数領域
//-------------------------------------------
...
void Init(void)
{
	...
	CLight::SetColor(0, CVector3D(0.2f, 0.2f, 0.2f), CVector3D(0.2f, 0.2f, 0.2f));
	...
	//モデルの読み込み
	ADD_RESOURCE("Vanguard", CModel::CreateModel("Charactor/VRoidA/VRoidA.a3m"));
	//当たり判定を持つ場合は、分割設定をしておく
	ADD_RESOURCE("Field", CModel::CreateModel("Field/Cube/Cube.obj", 2, 1, 2));
	ADD_RESOURCE("Sky", CModel::CreateModel("Field/Sky/Sky2.obj"));
